...
# 16-bit instruct weights + matching multimodal projector (image).
MODELS=(
...
echo
echo "Done. llama.cpp example (BF16 weights ~50.5 GB; MoE, 4B active):"
echo "  llama-server \\"
echo "    -m $OUT_DIR/gemma-4-26B-A4B-it-BF16.gguf \\"
echo "    --mmproj $OUT_DIR/mmproj-gemma-4-26B-A4B-it-BF16.gguf \\"
echo "    --device Vulkan0 -ngl 99 --sleep-idle-seconds 300 \\"
echo "    --jinja --temp 1.0 --top-p 0.95 --top-k 64 --min-p 0 -c 32768 \\"
